          ...
          <div style={{ flex: 1, display: "flex", gap: 0, overflow: "hidden" }}>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", padding: 20, overflow: "auto" }}>
              <div style={{ position: "relative", borderRadius: 16, overflow: "hidden", boxShadow: `0 4px 40px ${d ? "rgba(0,0,0,0.5)" : "rgba(0,0,0,0.12)"}`, width: "100%", maxWidth: 240 }}>
                ...
                {loadingItem && (
                  <div style={{ position: "absolute", inset: 0, background: "rgba(193,123,90,0.15)", display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(2px)" }}>
                  ...
                  <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "linear-gradient(transparent, rgba(0,0,0,0.7))", padding: "20px 12px 10px" }}>
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
                      {selectedItemData.map(item => (
                        <span key={item.id} style={{ background: "rgba(255,255,255,0.2)", backdropFilter: "blur(4px)", color: "#fff", borderRadius: 6, padding: "3px 8px", fontSize: 10 }}>{item.name}</span>
                      ))}
                    </div>
                  </div>
                )}
